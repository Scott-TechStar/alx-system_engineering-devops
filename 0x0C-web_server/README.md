...
* **5. Design a beautiful 404 page**
  * A custom-designed 404 error page for my server, accessible at
  [scotttechstar.tech/404](http://scotttechstar.tech/404).

* **6. Deploy fast, deploy well**
  * [7-puppet_install_nginx_web_server.pp](./7-puppet_install_nginx_web_server.pp): Install Nginx web server (w/ Puppet)
